...
const ar: Dictionary = {
  ...
  personalCalculator: {
    ...
    euDhlApproximationNote:
      "تكلفة DHL المضمّنة في سعر الكرتونة أدناه هي تعرفة البريد الألماني الخاصة بالاتجاه المعاكس (من ألمانيا إلى بلدك) — تقدير قريب، وليست تعرفة مخصصة لهذا المسار بالتحديد.",
    xxlPickupOnly:
