...
const ar: Dictionary = {
  ...
  personalCalculator: {
    ...
    dhlZoneNote:
      "خارج برلين/براندنبورغ — سترسلها إلينا عبر DHL، وهذا محتسب مسبقًا في السعر الإجمالي أدناه.",
    euDhlApproximationNote:
      "تكلفة DHL المضمّنة في السعر أدناه هي تعرفة البريد الألماني الخاصة بالاتجاه المعاكس (من ألمانيا إلى بلدك) — تقدير قريب، وليست تعرفة مخصصة لهذا المسار بالتحديد.",
    xxlPickupOnly:
